...
$H_A$: [$\mu_{math.vouch.y1}$ \- $\mu_{math.vouch.y0}$] \- [$\mu_{math.no.vouch.y1}$ - $\mu_{math.no.vouch}$] $\ne 0$ 
...
```
The boxplots support the conclusion that proportion of all students in the sample (voucher and no-voucher) that are considered to be passing in math is significantly different between the Year 0 pre-test and Year 1 post-test. There is a noticable positive change from Year 0 to Year1 in the 1st Quartiles, the Medians, and the 3rd Quartiles. Additionally, the maximum value is significantly higher in Year1 than in Year0, excluding outliers, by approximately 15 percentage points.  
