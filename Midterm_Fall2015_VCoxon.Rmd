...
$H_A$: $\mu_{read.vouch.y1}$ - $\mu_{read.vouch.y0}$ - $\mu_{read.no.vouch.y1}$ - $\mu_{read.no.vouch.y0}$ $!= 0$ 
...
$H_A$: $\mu_{Kinder.y0}$ = $\mu_{grade1.y0}$ != $\mu_{grade2.y0}$ != $\mu_{grade3.y0}$ != $\mu_{grade4.y0}$ != $\mu_{grade5.y0}$ != $0$
```{r}
...
summary(aov(y0_math_percentile~Grade,clean.nyc))
summary.aov(lm(y0_math_percentile~Grade,clean.nyc))
```
With an observed probability of $p_{obs} = 0.00007$, we reject the null at the $\alpha_{0.001}$ level; there is statistical evidence that a difference between grades exists in the Year 0 math pre-test scores.
