...
```
Null: *There is no average difference in Year 0 pre-test math scores between students in different grades.*


$H_0$: $\mu_{read.vouch.y0}$ - $\mu_{read.vouch.y0}$ - $\mu_{read.no.vouch.y1}$ - $\mu_{read.no.vouch.y0}$ $= 0$
