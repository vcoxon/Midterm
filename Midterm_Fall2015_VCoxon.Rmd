...
```
Null: *There is no average difference in Year 0 pre-test math scores between students in grades 1 through 5.*


$H_0$: $\mu_{grade1.y0}$ = $\mu_{grade2.y0}$ = $\mu_{grade3.y0}$ = $\mu_{grade4.y0}$ = $\mu_{grade5.y0}$ = $0$


Alternative: *There is an average difference in Year 0 pre-test math scores between students in grades 1 through 5.*


$H_A$: $\mu_{grade1.y0}$ != $\mu_{grade2.y0}$ != $\mu_{grade3.y0}$ != $\mu_{grade4.y0}$ != $\mu_{grade5.y0}$ != $0$
