...
```
With an observed probability of $p_{obs} = 0.00007$ ($F_{obs} < F_{\alpha=0.10,df_1=1,df2=1415}$), we reject the null not only at the $\alpha_{0.10}$ level, but also at the $\alpha_{0.001}$ level; the statistical evidence supports differences between grades in Year 0 math pre-test scores.
