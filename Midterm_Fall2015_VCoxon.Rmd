...
summary(nyc$y0_read_percentile)
   ...
   0.00    4.00   16.00   22.78   34.00   99.00     815 
summary(nyc$y0_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    1.00    9.00   16.54   25.00   98.00     815 
summary(nyc$y1_read_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    8.00   20.00   26.06   40.00   97.00     586 
summary(nyc$y1_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
    0.0     5.0    15.0    22.3    34.0    99.0     586 
summary(nyc$y2_read_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    8.00   21.00   26.09   39.00   99.00     912 
summary(nyc$y2_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    5.00   16.00   23.56   37.00   99.00     912 
summary(nyc$y3_read_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00   20.00   33.00   32.63   44.00   95.00     865 
summary(nyc$y3_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
    0.0    20.0    32.0    32.5    45.0    99.0     865 
...
summary(clean.nyc$y0_read_percentile)
   ...
   0.00    4.00   16.00   22.57   34.00   99.00 
summary(clean.nyc$y0_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
   0.00    2.00    9.00   16.42   25.00   98.00 
summary(clean.nyc$y1_read_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
   0.00    7.00   18.00   24.63   37.50   97.00 
summary(clean.nyc$y1_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
   0.00    5.00   15.00   23.24   36.00   99.00 
summary(clean.nyc$y2_read_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    8.00   20.00   25.26   38.00   98.00     343 
summary(clean.nyc$y2_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00    5.00   16.00   24.24   37.00   99.00     343 
summary(clean.nyc$y3_read_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00   21.00   34.00   33.54   46.00   95.00     333 
summary(clean.nyc$y3_math_percentile)
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
   0.00   21.00   32.00   33.23   45.00   99.00     333 
