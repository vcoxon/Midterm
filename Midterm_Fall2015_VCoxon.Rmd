...
SE.mdiff.vouch <- sqrt(sd(clean.vouch$y0_math_percentile)^2/length(clean.vouch$y0_math_percentile) + sd(clean.vouch$y1_math_percentile)^2/length(clean.vouch$y1_math_percentile));print(SE.mdiff.vouch2)
...
SE.pool.diff.of.means <- sqrt(SE.mdiff.vouch^2 + SE.mdiff.no.vouch^2); print(SE.diff.of.means)
